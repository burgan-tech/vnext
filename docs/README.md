...
3. Read [Async Transition Execution Modes](architecture/async-transition-execution-modes.md) before changing `WorkflowExecution:AutoTransitionMode` (inline vs. per-hop scheduler jobs for chained transitions).
