...
**Tools**: Prefer repository search (`grep`, codebase search, or graph tools) over guessing. Open the C# files referenced in `performance-profiles.json` `sources` when verifying numeric limits.
