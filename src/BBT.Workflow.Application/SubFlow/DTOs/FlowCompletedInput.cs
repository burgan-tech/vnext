...
public record FlowCompletedInput
{
    ...
    /// <summary>
    /// Start of the activation episode the completing subflow was executing (its final request),
    /// which the parent resume inherits so its time-to-Active is measured from what the client
    /// actually waited for. See <c>WorkflowTraceLane.Episode</c>.
    /// </summary>
