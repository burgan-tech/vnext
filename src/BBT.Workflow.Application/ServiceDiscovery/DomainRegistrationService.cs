    ...
    ILogger<DomainRegistrationService> logger) : IDomainRegistrationService
{
    ...
    private const string DomainRegistrationWorkflow = "domain-registration";
    ...
    public async Task RegisterDomainAsync(CancellationToken cancellationToken = default)
    {
        ...
        var requestUrl = $"{registryBaseUrl}/api/v1/{registryDomain}/workflows/{DomainRegistrationWorkflow}/instances/start?sync=false";
