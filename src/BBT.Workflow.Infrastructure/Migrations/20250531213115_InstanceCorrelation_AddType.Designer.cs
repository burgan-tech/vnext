...
namespace BBT.Workflow.Migrations
{
    ...
    [Migration("20250531213115_InstanceCorrelation_AddType")]
    partial class InstanceCorrelation_AddType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BBT.Workflow.Instances.InstanceCorrelation", b =>
                {
                    ...
                    b.HasOne("BBT.Workflow.Instances.Instance", null)
                        ...
                        .HasForeignKey("BBT.Workflow.Instances.InstanceCorrelation", "SubFlowInstanceId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                });
