...
namespace BBT.Workflow.Migrations
{
    ...
    [Migration("20260810090125_InstanceRevisionAndDurableJobs")]
    partial class InstanceRevisionAndDurableJobs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BBT.Workflow.Instances.Instance", b =>
                {
                    ...
                    b.Property<int?>("CurrentStateSubType")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BBT.Workflow.Instances.InstanceJob", b =>
                {
                    ...
                    b.Property<Guid?>("AdmissionToken")
                        .HasColumnType("uuid");

                    b.Property<long?>("AdmittedRevision")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("InstanceId", "IdempotencyKey")
                        .IsUnique()
