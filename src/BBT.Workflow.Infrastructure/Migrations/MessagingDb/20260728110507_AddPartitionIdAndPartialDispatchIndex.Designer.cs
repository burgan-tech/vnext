...
namespace BBT.Workflow.Migrations.MessagingDb
{
    ...
    [Migration("20260728110507_AddPartitionIdAndPartialDispatchIndex")]
    partial class AddPartitionIdAndPartialDispatchIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BBT.Aether.Domain.Events.InboxMessage", b =>
                {
                    ...
                    b.HasIndex("HandledTime")
                        .HasDatabaseName("IX_InboxMessages_Retention")
                        .HasFilter("\"Status\" = 2");

                    b.HasIndex("PartitionId", "NextRetryTime", "CreatedAt")
            ...
            modelBuilder.Entity("BBT.Aether.Domain.Events.OutboxMessage", b =>
                {
                    ...
                    b.HasIndex("PartitionId", "NextRetryAt", "CreatedAt")
