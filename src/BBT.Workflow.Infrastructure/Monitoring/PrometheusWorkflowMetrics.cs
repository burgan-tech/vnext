...
public sealed class PrometheusWorkflowMetrics : IWorkflowMetrics
{
    ...
    public void RecordErrorBoundaryResolution(string workflow, string boundaryLevel, string action)
    {
        WorkflowMetrics.ErrorBoundaryResolutions
            .WithLabels(workflow, boundaryLevel, action)
            .Inc();
    }
    ...
    {
        WorkflowMetrics.SubFlowErrorPropagations
            .WithLabels(parentWorkflow, childWorkflow, propagated.ToString().ToLowerInvariant())
            .Inc();
    }
