...
public interface IUrlTemplateBuilder
{
    ...
    /// <summary>
    /// Builds URL for the instance function catalog endpoint.
    /// </summary>
    /// <param name="domain">The domain name</param>
    /// <param name="workflow">The workflow name</param>
    /// <param name="instance">The instance key or ID</param>
    /// <param name="apiVersionPrefix">Optional API version prefix (e.g., "api/v1")</param>
    /// <returns>Generated client-facing URL</returns>
    string BuildFunctionCatalogUrl(string domain, string workflow, string instance, string? apiVersionPrefix = null);
    ...
    /// <summary>
    /// Builds URL for the active-incident endpoint of an instance. Default interface member so
    /// external implementations keep compiling.
    /// </summary>
    /// <param name="domain">The domain name</param>
    /// <param name="workflow">The workflow name</param>
    /// <param name="instance">The instance key or ID</param>
    /// <param name="apiVersionPrefix">Optional API version prefix (e.g., "api/v1")</param>
    /// <returns>Generated client-facing active incident URL</returns>
    string BuildActiveIncidentUrl(string domain, string workflow, string instance, string? apiVersionPrefix = null)
        => $"{BuildIncidentsUrl(domain, workflow, instance, apiVersionPrefix)}/active";
}
