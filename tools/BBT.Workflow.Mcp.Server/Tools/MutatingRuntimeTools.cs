...
/// retry, publish definitions, invalidate cache). Registered <b>only</b> when
/// <c>Mcp:AllowMutations=true</c> — default-off to prevent accidental writes from
/// CI pipelines or autonomous agents.
/// </summary>
[McpServerToolType]
public sealed class MutatingRuntimeTools(IOrchestrationClient client)
{
    ...
    public Task<JsonNode?> StartInstanceAsync(
        ...
        client.SendAsync(domain, HttpMethod.Post, $"{E(domain)}/workflows/{E(workflow)}/instances/start", Parse(body), query: null, cancellationToken);
    ...
    public Task<JsonNode?> RunTransitionAsync(
        ...
        CancellationToken cancellationToken = default) =>
        client.SendAsync(domain, HttpMethod.Patch, $"{E(domain)}/workflows/{E(workflow)}/instances/{E(instance)}/transitions/{E(transitionKey)}", Parse(body), query: null, cancellationToken);
    ...
    public Task<JsonNode?> RetryInstanceAsync(
        ...
        CancellationToken cancellationToken = default) =>
        client.SendAsync(domain, HttpMethod.Post, $"{E(domain)}/workflows/{E(workflow)}/instances/{E(instance)}/retry", Parse(body), query: null, cancellationToken);
    ...
    public Task<JsonNode?> PublishDefinitionsAsync(
        ...
        CancellationToken cancellationToken = default) =>
        client.SendAsync(domain: null, HttpMethod.Post, "definitions/publish", Parse(body), query: null, cancellationToken);
    ...
    public Task<JsonNode?> InvalidateCacheAsync(
        ...
        CancellationToken cancellationToken = default) =>
        client.SendAsync(domain: null, HttpMethod.Post, "utilities/invalidate", Parse(body), query: null, cancellationToken);
